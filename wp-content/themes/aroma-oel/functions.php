...
function aromaoel_assets() {
	...
	wp_enqueue_style( 'aromaoel-style', get_stylesheet_uri(), array(), '1.1' );
	wp_enqueue_script( 'aromaoel-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.1', true );
}
...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'aromaoel-hero', 1600, 1000, true );
	add_image_size( 'aromaoel-block', 900, 700, true );
}
...
/* 6. WooCommerce — retirer wrapper par défaut pour custom design */
